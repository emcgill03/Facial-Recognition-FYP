...
class Settings(object):
    ...
    def __init__(self):
        ...
        self.MOG2learningRate = 0.6 #0.001 #0 means that the background model is not updated at all, 1 means that the background model is completely reinitialized from the last frame.
        ...
        self.movementTime = 60 # number of frames after the alarm is triggered
        self.location = 'Living Room'
        self.phone = '07544968348'
        #self.email = 'steve.tan.chee.wei@gmail.com'
        self.email = 'emcgill03@hotmail.com'
        self.apiKey = 'ee13fadb-5c52799d'   #update your API here
